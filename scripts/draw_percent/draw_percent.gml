...
function draw_percent(x,y,sprite,subimg,percent,color=c_white,alpha=1){
	...
	draw_sprite_stretched_ext(sprite,subimg,0,0,sprite_get_width(sprite),sprite_get_height(sprite), color, alpha);
